...
st.markdown("<p style='text-align: center; color: #64748b; font-size: 16px; margin-bottom: 30px;'>Comprehensive analysis of 1,000+ job listings powered by real-time data pipeline</p>", unsafe_allow_html=True)
...
st.markdown("""
    <div style='text-align: center; padding: 20px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px; color: white;'>
        ...
        <p style='margin: 5px 0; font-size: 13px;'>Data Source: 1,000 job listings | Last Updated: 2025-12-06 06:52 UTC | Pipeline Status: ✅ Active</p>
